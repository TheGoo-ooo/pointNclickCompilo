...
_lr_productions = [
  ...
  ('statement -> ID = expression','statement',3,'p_statement','parserPandCl.py',30),
  ('statement -> member = expression','statement',3,'p_statement','parserPandCl.py',31),
  ('statement -> structure','statement',1,'p_statement','parserPandCl.py',32),
  ('statement -> EMPTY','statement',1,'p_statement','parserPandCl.py',33),
  ('statement -> PRINT expression','statement',2,'p_statement','parserPandCl.py',34),
  ('structure -> WHILE ( expression ) { program }','structure',7,'p_structure','parserPandCl.py',51),
  ('structure -> IF ( expression ) { program }','structure',7,'p_structure','parserPandCl.py',52),
  ('structure -> : expression','structure',2,'p_structure','parserPandCl.py',53),
  ('scene -> SCENE ( expression , [ id_list ] )','scene',8,'p_scene_type','parserPandCl.py',64),
  ('cli -> CLI ( expression , rect ) { program }','cli',9,'p_cli_type','parserPandCl.py',69),
  ('rect -> RECT ( expression , expression , expression , expression )','rect',10,'p_rect_type','parserPandCl.py',73),
  ('id_list -> expression','id_list',1,'p_id_list','parserPandCl.py',77),
  ('id_list -> expression , id_list','id_list',3,'p_id_list','parserPandCl.py',78),
  ('expression -> expression ADD_OP expression','expression',3,'p_expression_op','parserPandCl.py',87),
  ('expression -> expression MULT_OP expression','expression',3,'p_expression_op','parserPandCl.py',88),
  ('expression -> NUMBER','expression',1,'p_number','parserPandCl.py',92),
  ('expression -> ID','expression',1,'p_variable','parserPandCl.py',96),
  ('expression -> STRING','expression',1,'p_string','parserPandCl.py',101),
  ('expression -> scene','expression',1,'p_scene','parserPandCl.py',105),
  ('expression -> cli','expression',1,'p_cli','parserPandCl.py',109),
  ('expression -> { program }','expression',3,'p_cliprog','parserPandCl.py',113),
  ('expression -> ( expression )','expression',3,'p_parenthesis','parserPandCl.py',117),
  ('member -> expression . climember','member',3,'p_member','parserPandCl.py',121),
  ('expression -> expression [ expression ]','expression',4,'p_rect','parserPandCl.py',128),
  ('climember -> FUNC','climember',1,'p_climember','parserPandCl.py',133),
  ('climember -> IMG','climember',1,'p_climember','parserPandCl.py',134),
  ('climember -> X','climember',1,'p_climember','parserPandCl.py',135),
  ('climember -> Y','climember',1,'p_climember','parserPandCl.py',136),
  ('climember -> W','climember',1,'p_climember','parserPandCl.py',137),
  ('climember -> H','climember',1,'p_climember','parserPandCl.py',138),
  ('expression -> ADD_OP expression','expression',2,'p_uminus','parserPandCl.py',146),
]
