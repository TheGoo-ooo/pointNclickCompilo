...
img2 = pygame.image.load("Assets/orange_scene1.png")
img3 = pygame.image.load("Assets/orange_scene2.png")
def f0():
    print(None)
...
sc_1 = {}
sc_1 = {'bg' : img2, 'cli' : [cli_switchScene]}
sc_2 = {}
sc_2 = {'bg' : img3, 'cli' : [cli_empty]}
currentScene = sc_1
